...
def spotify_callback():
    ...
    token = SpotifyOAuth(scope=scope, client_id=app.config['SPOTIPY_CLIENT_ID'], client_secret=app.config['SPOTIPY_CLIENT_SECRET'],
                         redirect_uri=app.config['SPOTIPY_REDIRECT_URI'], show_dialog=False)
    print("kazi mi", token.get_access_token(as_dict=True))
